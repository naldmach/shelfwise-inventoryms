                    ...
                    <div class="card-header bg-light">
                        ...
                        >
                            <h5 class="card-title mb-0">
                                <i
                                    class="fas fa-warehouse text-primary me-2"
                                ></i>
                                {{ warehouse.name }}
                            </h5>
                            <div class="dropdown">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <div class="warehouse-icon-large mx-auto mb-3">
                                    <i
                                        class="fas fa-warehouse fa-4x text-primary"
                                    ></i>
                                </div>
                                <small class="text-muted"
                                    >Warehouse ID:
                                    {{ selectedWarehouse.id }}</small
                                >
                            </div>
                        </div>
                    </div>
    ...
    methods: {
        ...
        filterWarehouses() {
            ...
            if (this.statusFilter) {
                ...
                filtered = filtered.filter(
                    (warehouse) => warehouse.is_active === isActive
                );
            }
        ...
        sortWarehouses(warehouses = null) {
            ...
            whs.sort((a, b) => {
                switch (this.sortBy) {
                    ...
                    case "products_count":
                        return (
                            (b.products_count || 0) - (a.products_count || 0)
                        );
                    default:
                        return 0;
                }
        ...
        async deleteWarehouse(warehouse) {
            if (
                confirm(`Are you sure you want to delete "${warehouse.name}"?`)
            ) {
                try {
